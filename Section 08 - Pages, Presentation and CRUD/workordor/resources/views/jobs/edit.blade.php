    ...
    <main class="container mx-auto p-4 mt-4">
        <div class="bg-blue-900 mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
            ...
            <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
                ...
                <x-inputs.text type="text" id="title" name="title" label="Job Title" placeholder="e.g. Web Developer" 
                ...
                <x-inputs.text-area id="benefits" name="benefits" label="Job Benefits" 
                    ...
                    :value="old('benefits', $job->benefits)" rows="4" />
                ...
                <x-inputs.text type="text" id="city" name="city" label="City" 
                    placeholder="e.g. Toronto"
                    :value="old('city', $job->city)" />

                <x-inputs.text type="text" id="state" name="state" label="State" 
                    placeholder="e.g. ON"
